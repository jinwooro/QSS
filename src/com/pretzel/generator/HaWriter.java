...
public class HaWriter {
	...
	public HaWriter (String filename, double simulationTime) throws IOException {
		...
		createFile("generated/__init__.py"); // this is an empty file
	...
	public void writeCharts(HashSet<HIOA> HIOAs) throws IOException {
		if (HIOAs.size() == 0) return;
		
		createFile(CHART_FILE);
		String buff = "";
		for (HIOA ha : HIOAs) {
